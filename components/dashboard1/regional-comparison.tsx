...
function RegionalComparison({
  ...
  useEffect(() => {
    ...
    // Add Y axis
    svg.append("g").call(yAxis).selectAll("text").attr("font-size", "16px");
...
export default function CovidDashboard() {
  ...
  const endpoints = {
    ...
    vaccinated:
      "https://is428project.onrender.com/top10_countries_by_vaccination",
  };
  ...
  return (
    <div className="p-4 space-y-6">
      <h1 className="text-2xl font-bold">
        Top 10 Countries by COVID-19 Statistics
      </h1>
      ...
      <Tabs value={currentTab} onValueChange={handleTabChange}>
        ...
        <div className="mt-6">
          <h2 className="text-xl font-semibold">
            Top 10 Countries by {getTabTitle()}
          </h2>
